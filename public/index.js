async function xpenseManager(event){
    ...
    const obj1 = {
        ...
        categry: option.value 
    }
    
    console.log(obj1)
    
    let response = await axios.post("http://localhost:4000/expense/add-expense",obj1)
...
function showDetailOnScreen(obj1){
    ...
    childele.textContent = obj1.amount+ '  ' + obj1.description + '  '+ obj1.categry;
